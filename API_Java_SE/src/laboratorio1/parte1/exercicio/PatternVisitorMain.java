...
public class PatternVisitorMain {
    ...
    public static void main(String[] args) {
        ...
        carrinhoDeCompras.accept(new AplicarCupomDeDescontoVisitor());
        System.out.println(String.format("Valor nota fiscal com o desconto aplicado: %s", carrinhoDeCompras.getValorASerPago()));
